...
class Engine {
  ...
  resize() {
    // Always use window dimensions — the canvas is 100vw × 100vh via CSS
    // canvas.clientWidth can be 0 on first mount when created dynamically,
    // which would render everything to a 1×1 pixel (invisible)
