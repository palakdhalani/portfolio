class Label {
  ...
  createElement() {
    ...
    element.innerHTML = `
      ...
      <article class="plane-label-card plane-label-overlay__right">
        ...
        <p class="plane-label-card__project-title"></p>
        <a class="plane-label-card__visit-link" href="#" target="_blank" rel="noopener" style="display:none">Visit Project →</a>
      </article>
    `
    ...
    return {
      ...
      projectTitleElement: element.querySelector('.plane-label-card__project-title'),
      visitLinkElement: element.querySelector('.plane-label-card__visit-link'),
    }
  }
  ...
  init() {
    ...
    this.projectTitleElement = projectTitleElement
    this.visitLinkElement = visitLinkElement
  ...
  applyPlaneContent(planeIndex) {
    ...
    const projectTitle = plane.userData.projectTitle || ''
    const projectUrl = plane.userData.projectUrl || ''
    ...
    if (this.projectTitleElement) {
      this.projectTitleElement.textContent = projectTitle
    }
    if (this.visitLinkElement) {
      if (projectUrl) {
        this.visitLinkElement.href = projectUrl
        this.visitLinkElement.style.display = 'inline-block'
        this.visitLinkElement.style.color = labelData.color || '#ffffff'
      } else {
        this.visitLinkElement.style.display = 'none'
      }
    }
